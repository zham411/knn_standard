# Standard K's nearest neighbor application.
# No specific notation. Universal implementation applied.
...
def classifier(train_data, train_target, classes, point, k=5):
    ...
    k closest points are plotted (ranked in ascending order of euclidean distance)
    Params:
